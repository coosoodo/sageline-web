      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#050a14]/90 backdrop-blur-xl">
        <div className="container mx-auto flex h-20 max-w-7xl items-center justify-between px-8">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden lg:flex items-center gap-4 text-xs font-bold text-slate-500 bg-white/5 px-4 py-2 rounded-full border border-white/5">
              <span className="flex items-center gap-1.5"><Tag size={12} className="text-emerald-400"/> v{version}</span>
              <span className="h-3 w-px bg-white/10"></span>
              <span className="flex items-center gap-1.5"><Clock size={12} className="text-cyan-400"/> {lastUpdated}</span>
            </div>
            <Link href="/" className="text-xs font-black uppercase tracking-[0.2em] text-emerald-400 hover:text-white transition-colors">
              Back to Home
            </Link>
          </div>
        </div>
      ...
      <div className="container mx-auto max-w-7xl px-8 py-12 flex-grow">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-64 flex-shrink-0 lg:sticky lg:top-32 h-fit">
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-2 backdrop-blur-sm">
          ...
          <main className="flex-grow">
            {/* 상단 섹션 */}
            <div className="mb-12 p-8 rounded-3xl border border-white/5 bg-gradient-to-br from-emerald-500/10 via-cyan-500/5 to-transparent relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <BookOpen size={120} className="text-white" />
              </div>
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-emerald-400 mb-4 px-3 py-1 rounded-full bg-emerald-400/10 border border-emerald-400/20">
                ...
                <p className="text-lg text-slate-400 font-light max-w-2xl">
                  ...
                  처음 사용하시는 경우 <span className="text-emerald-400">설치 및 초기 설정</span> 섹션부터 시작해 주세요.
                </p>
              </div>
            </div>
            ...
            <footer className="mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="text-sm text-slate-500 font-medium tracking-widest uppercase">
                © 2026 SAGELINE. All rights reserved.
              </div>
              <div className="flex items-center gap-4">
                <a href="#" className="flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-emerald-400 transition-colors uppercase tracking-widest">
